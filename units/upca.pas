...
uses
  utypes, ujacobi, umachar, uConstants;

procedure VecMean(X: TMatrix; Lb, Ub, Nvar: Integer; out M: TVector);
{ ----------------------------------------------------------------------
...
procedure VecSD(X: TMatrix; Lb, Ub, Nvar: Integer; M: TVector; out S: TVector);
{ ----------------------------------------------------------------------
...
procedure MatVarCov(X: TMatrix; Lb, Ub, Nvar: Integer; M: TVector;
  out V: TMatrix);
{ ----------------------------------------------------------------------
...
procedure MatCorrel(V: TMatrix; Nvar: Integer; out R: TMatrix);
{ ----------------------------------------------------------------------
...
procedure PCA(R: TMatrix; Nvar: Integer; MaxIter: Integer; Tol: Float;
  out Lambda: TVector; out C, Rc: TMatrix);
{ ----------------------------------------------------------------------
...
procedure ScaleVar(X: TMatrix; Lb, Ub, Nvar: Integer; M, S: TVector;
  out Z: TMatrix);
{ ----------------------------------------------------------------------
...
procedure PrinFac(Z: TMatrix; Lb, Ub, Nvar: Integer; C: TMatrix;
  out F: TMatrix);
{ ----------------------------------------------------------------------
