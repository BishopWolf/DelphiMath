...
uses
  utypes, math, uminmax, umachar, uConstants;

procedure Hqr(H: TMatrix; Lb, Ub, I_low, I_igh: Integer;
  out Lambda: TCompVector);
...
320: { Complex pair }
  Lambda[Na].Real := X + P;
  Lambda[En].Real := X + P;
  Lambda[Na].Imaginary := Z;
  Lambda[En].Imaginary := -Z;
