...
procedure Wilcoxon(X, Y: TVector; Lb, Ub: Integer; var Ndiff: Integer;
  var T, Eps: Float);
{ ------------------------------------------------------------------
  Wilcoxon test
  ------------------------------------------------------------------ }

procedure Kruskal_Wallis(Ns: Integer; N: TIntVector; X: TMatrix; var H: Float;
  var DoF: Integer);
{ ------------------------------------------------------------------
  Kruskal-Wallis test
  ------------------------------------------------------------------ }
...
procedure Ranks(Ns: Integer; N: TIntVector; X: TMatrix; out Sr: TVector;
  out Corr: Float);
{ ------------------------------------------------------------------
