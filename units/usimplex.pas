...
uses
  utypes, unlfit, umachar, uConstants;

type
  TSimplex = class(TBaseOptAlgo)
  public
    procedure SaveSimplex(FileName: string);
    { Opens a file to save the Simplex iterations }
    procedure Simplex(Func: TFuncNVar; var X: TVector; Lb, Ub, MaxIter: Integer;
      Tol: Float; out F_min: Float);
  end;
...
procedure TSimplex.SaveSimplex(FileName: string);
begin
...
procedure TSimplex.Simplex(Func: TFuncNVar; var X: TVector; Lb, Ub: Integer;
  MaxIter: Integer; Tol: Float; out F_min: Float);
const
