...
uses
  uConstants, ugamma, uibeta, uinvnorm;

function InvBeta(A, B, Y: Float): Float;
{ ------------------------------------------------------------------
  Inverse of incomplete Beta function.
  Given Y, the function finds X such that IBeta(A, B, X) = Y
  ------------------------------------------------------------------ }
...
begin
  ...
  d := yp * Sqrt(x + lgm) / x - (1.0 / (2.0 * b1 - 1.0) - 1.0 / (2.0 * a1 - 1.0)
