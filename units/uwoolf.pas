...
procedure Woolf_Conform(N_cls: Integer; N_estim: Integer; Obs: TIntVector;
  Calc: TVector; var G: Float; var DoF: Integer);
{ ------------------------------------------------------------------
  Woolf test for conformity
  ------------------------------------------------------------------ }

procedure Woolf_Indep(N_lin: Integer; N_col: Integer; Obs: TIntMatrix;
  var G: Float; var DoF: Integer);
{ ------------------------------------------------------------------
